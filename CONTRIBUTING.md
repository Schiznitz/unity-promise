...
1. Make an [Issue](https://github.com/schiznitz/unity-promise/issues/new)
...
```json
    {
        "dependencies": {
            "com.schiznitz.unity-promise": "https://github.com/YOUR_USER/unity-promise.git"
        }
    }
```
...
reported to the community leaders responsible for enforcement at me@schiznitz.com.
